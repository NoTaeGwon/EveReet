package EveReet.controller.shop;

import EveReet.controller.shop.*;
...
public class ShopFrontController extends HttpServlet implements Servlet{
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("shopPageInfoVO") == null) {
			bpiVO = new ShopPageInfoVO();
			session.setAttribute("shopPageInfoVO", bpiVO);
		} else {
		...
		switch( command ) {
		case "/insertShop.sh":
			action = new InsertShopAction();
			break;
		case "/getShopList.sh":
			action = new GetShopListAction();
			break;
		case "/getShopListForPage.sh":
			action = new GetShopListForPageAction();
			break;
		case "/getAllProduct.sh":
			action = new GetAllProductAction();
			break;
		case "/adjustBPI.sh":
			action = new AdjustBPIAction();
			break;
		case "/deleteShopForID.sh":
			action = new DeleteShopForIDAction();
			break;
		case "/deleteShopListDisplay.sh":
			action = new DeleteShopListDisplayAction();
			break;	
		case "/updateShopListDisplay.sh":
			action = new UpdateShopListDisplayAction();
			break;
		case "/updateShopDisplay.sh":
			action = new UpdateShopDisplayAction();
			break;
		case "/updateShopForID.sh":
			action = new UpdateShopForIDAction();
			break;
		case "/getDetailProductInfo.sh":
			action = new GetDetailProductInfoAction();
			break;
		case "/addToCart.sh":
