...
<head>
<meta charset="UTF-8">
<title>EveReet - 회원정보수정(U)</title>
</head>
<body>
<h1>EveReet - 회원정보수정(U)</h1>
<hr>
<%
	MemberDTO member;
...
%>		
		<tr>
			...
			<td><a href="./updateMemberDisplay.me?id=<%=member.getId()%>">UPDATE</a></td>
			</tr>
<%
	}
%>
...
<a href="./updateMemberListDisplay.me?currentPageNo=0">[FIRST]</a>
<%
	if( currentPageNo > 0){		
%>
	<a href="./updateMemberListDisplay.me?currentPageNo=<%=(currentPageNo-1) %>">[PRE]</a>
<%
	}else{
%>	
	[PRE]
...
%>
			<a href="./updateMemberListDisplay.me?currentPageNo=<%=i%>">[<%=(i+1)%>]</a>
<%
		}
	}
%>
...
%>
	<a href="./updateMemberListDisplay.me?currentPageNo=<%=(currentPageNo+1)%>">[NXT]</a>
<%
	}else{
%>
	[NXT]	
...
%>
 	<a href="./updateMemberListDisplay.me?currentPageNo=<%=(bpiVO.getPageCnt()-1)%>">[END]</a>
